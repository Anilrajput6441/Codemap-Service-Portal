...
const PartnerPage = () => {
  return (
      ...
      
    {
      ...
      <><TitleComponent title="Partnership Page" slogan="Partner with one of the best software development agency in India" /><div className="partnerContainer  pt-7 pb-7">
      <p className='text-[9vmin] font-extrabold ml-4'>Why <span className='text-deepViolet'>Codemap?</span></p>
      <div className="partnerUs w-[100vw]  flex flex-wrap justify-center items-center mt-3">
        ...
        <div className="w-[92vw] flex flex-col justify-center items-center ">
          ...
          <div className="imageHolder w-[92vw] flex justify-center items-center">
            <img src={require("../../assets/teamicon.avif")} alt='Partnership Image' className='max-w-full max-h-full object-contain' />
          </div>
        </div>
        ...
        <div className="w-[96vw] flex flex-col  text-[3.75vmin] ml-2 mt-[-1.25vmin] p-2 ">
          ...
          <div className='mt-7 font-poppins'>
            <p className='leading-[7.25vmin]'>Codemap is a leading software development and consulting firm in India. We provide  our technical solutions and consulting services pan India across multiple business domains in India like Finance, HealthCare, HR,  Education and many more.With an experienced team,We want to deliver the best quality software solutions to our client. The reasons to partner with codemap is as  follows:</p>
            ...
            <ol className='leading-[7.25vmin]'>
              ...
              <li>3. We believe in trust building and mutual benefits within the business partners and their stakeholders.</li>
              <li>4. With moto of making strong collaborative partners to excel and grow both of the partners</li>

            </ol>
          </div>

          <button className='bg-deepViolet text-white p-2 mt-6 text-[2.65vmin] w-[35%] text-[3.65vmin]'><a href='#hero'>Connect Now !!!</a></button>
        </div>
      ...
      <><div className="mainBody w-[100vw] bg-backgroundMain flex flex-wrap pb-20">
          ...
          </div><div className="partnerContainer  pt-10 pb-20">
              <p className='text-[7vmin] font-extrabold ml-8'>Why <span className='text-deepViolet'>Codemap?</span></p>
              <div className="partnerUs w-[100vw]  flex flex-wrap justify-center items-center">
                ...
                <div className="w-[35vw] flex flex-col justify-center items-center mt-8">
                  ...
                  <div className="imageHolder w-[35vw] h-[90vh] flex justify-center items-center">
                    <img src={require("../../assets/teamImage.jpg")} alt='Partnership Image' className='max-w-full max-h-full object-contain' />
                  </div>
                </div>
          ...
          <button className='bg-deepViolet text-white p-2 mt-9 text-[2.45vmin] w-[35%] 2xl:w-1/4 text-[2.25vmin]'><a href='#hero'>Connect Now !!!</a></button>
                </div>
