      ...
      <div>
        {(props.type === "Service" &&
          (screen.width <= 1700 || screen.width >= 1730) && (
            <div className="bg-white card flex flex-col items-center justify-center pl-3 pr-4 md:pr-0 md:p-3 md:pl-2 w-[68vw] h-[70vmin]  md:w-[50vmin] lg:w-[50vmin] 2xl:w-[52vmin]  border-[#d0cfcf] border-[1px] md:h-[40vmin] gap-y-5  pr-1">
              <div className="imageHolder">
                {(props.data.title === "Website Development" &&
                  screen.width > 1000 && (
                    <div className="imageHolder w-[11vmin] h-[11vmin]">
                      <img
                        src={require("../../assets/web-development.png")}
                        className="max-w-full max-h-full object-conatin"
                      />
                    </div>
                  )) ||
                  (props.data.title === "Android Development" &&
                    screen.width > 1000 && (
                      <div className="imageHolder w-[11vmin] h-[11vmin]">
                        <img
                  ...
                  (props.data.title === "Custom  Development" &&
                    screen.width > 1000 && (
                      <div className="imageHolder w-[11vmin] h-[11vmin]">
                        <img
                ...
                {(props.data.title === "Website Development" &&
                  screen.width < 1000 && (
                    <div className="imageHolder w-[20vmin] h-[20vmin] md:w-[15vmin] md:h-[15vmin]">
                      <img
                        src={require("../../assets/web-development.png")}
                        className="max-w-full max-h-full object-conatin"
                      />
              ...
              <div className="flex flex-col justify-center items-center">
                <div className="titleHolder">
                  <p className="font-bold text-[5vmin] md:text-[3.35vmin]  ">
                    {props.data.title}
                  </p>
                </div>
                <div className="captionBody w-[100%] lg:w-[76%] flex justify-center items-center text-textGrey text-[3vmin] md:text-[2.15vmin]">
                  <p className="mt-2 text-[3.45vmin] md:text-[2.25vmin] 2xl:text-[2vmin] pl-2">
                    {props.data.descr}
                  </p>
                </div>
              </div>
          ...
          (props.type === "Service" &&
            (screen.width > 1700 || screen.width < 1730) && (
              <div className="bg-white card flex flex-col items-center justify-center pl-3 pr-4 md:pr-0 md:p-3 md:pl-2 w-[62vw] h-[70vmin]  md:w-[44vmin] 2xl:w-[45vmin]  border-[#d0cfcf] border-[1px] md:h-[40vmin] gap-y-5  pr-1">
                <div className="imageHolder">
                  {(props.data.title === "Website Development" &&
                    screen.width > 1000 && (
                      <img
                ...
                <div className="flex flex-col justify-center items-center">
                  ...
                  <div className="captionBody w-[100%] lg:w-[80%]  text-textGrey text-[3vmin] md:text-[2.15vmin]">
                    <p className="mt-2 text-[3.45vmin] md:text-[2.15vmin] ml-3">
                      {props.data.descr}
                    </p>
                  </div>
                </div>
          ...
          (props.type === "Team" && orientation != "reverse" && (
            <div className="teamcard w-[90vw] md:w-[98vmin] lg:w-[110vmin] flex flex-wrap md:gap-x-3 mt-4">
              ...
              <div className="textHolder w-[96vw] md:w-[70vmin] flex flex-col justify-center mt-3 lg:mt-0 lg:ml-5 ">
                <div className="personalInfo flex gap-x-3">
                  <p className="font-poppins font-bold text-[5vmin] md:text-[3.45vmin]">
                    {props.data.name}
                  </p>
                ...
                {screen.width < 1000 && (
                  <div className="descriptionHolder ">
                    <p className="font-poppins mt-2 text-[3.45vmin] md:text-[2vmin]">
                      {props.data.description}
                    </p>
                  </div>
                )}
                {screen.width < 1700 && screen.width >= 1000 && (
                  <div className="descriptionHolder pl-1">
                    <p className="text-[2.1vmin] pr-3 font-poppins mt-2">
                      {props.data.description}
                    </p>
                  </div>
                )}
                ...
                {screen.width >= 1900 && screen.width <= 2047 && (
                  <div className="descriptionHolder pl-1">
                    <p className="text-[1.87vmin] pr-1 font-poppins mt-1">
                      {props.data.description}
                    </p>
                  </div>
                )}
                {screen.width >= 2048 && (
                  <div className="descriptionHolder pl-1 mt-2">
                    <p className="text-[2.1vmin] pr-1 font-poppins">
                      {props.data.description}
                    </p>
                  </div>
                )}
          ...
          (props.type === "Team" && orientation === "reverse" && (
            <div className="teamcard w-[90vw] md:w-[98vmin] lg:w-[110vmin] flex flex-wrap-reverse md:gap-x-3 mt-4">
              <div className="textHolder w-[95vw] md:w-[68vmin] flex flex-col justify-center  mt-3 lg:mt-0 lg:ml-5">
                ...
                {screen.width >= 1700 && screen.width <= 1900 && (
                  <div className="descriptionHolder pl-1 mt-2">
                    <p className="text-[1.87vmin] pr-3 font-poppins">
                      {props.data.description}
                    </p>
                  </div>
                )}
                {screen.width >= 1900 && screen.width <= 2047 && (
                  <div className="descriptionHolder pl-1 mt-2">
                    <p className="text-[1.87vmin] pr-1 font-poppins">
                      {props.data.description}
                    </p>
                  </div>
                )}
            ...
            <div className="teamcard w-[90vw]   lg:w-[130vmin] flex flex-wrap md:gap-x-3 bg-lightGrey p-5 pb-9 rounded-lg mr-[1vmin]  border-gray border-[1px]">
              ...
              <div className="textHolder w-[96vw] md:w-[70vmin] flex flex-col justify-center mt-3 lg:mt-0 lg:ml-5 ">
                <div className="personalInfo flex gap-x-3">
                  <p className="font-poppins font-bold text-[5vmin] md:text-[3.45vmin]">
                    Project:{" "}
                    <span className="font-normal  text-[4vmin] md:text-[2.75vmin]">
                      &nbsp;{props.data.title}
                    </span>
                  </p>
                </div>
                ...
                {screen.width < 1000 && (
                  <div className="descriptionHolder ">
                    <p className="font-poppins mt-2 text-[3.45vmin] md:text-[2vmin]">
                      <span className="font-poppins font-bold text-[5vmin] md:text-[3vmin] ">
                        Description:
                      </span>
                      <span className="text-[3.85vmin] md:text-[2.55vmin]">
                        &nbsp;{props.data.description}
                      </span>
                    </p>
                  </div>
                ...
                <div className="buttonHolder flex gap-x-6 mt-8">
                  <button className="bg-[#628600] text-white p-3 md:text-[2.45vmin]">
                    See Screenshots
                  </button>
                  {props.data.live === true && (
                    <button className="bg-deepViolet text-white p-3 md:text-[2.45vmin]">
                      Live Link
                    </button>
                  )}
                </div>
          ...
          (props.type === "Projects" && orientation === "reverse" && (
            <div className="teamcard w-[90vw]   lg:w-[130vmin] flex flex-wrap-reverse md:gap-x-3 mt-4 bg-lightGrey p-5 pb-9 rounded-lg mr-[1vmin] border-gray border-[1px]">
              <div className="textHolder w-[95vw] md:w-[65vmin] flex flex-col justify-center  mt-3 lg:mt-0 lg:ml-5">
                ...
                {screen.width < 1700 && screen.width >= 1000 && (
                  <div className="descriptionHolder pl-1">
                    <p className="text-[2.15vmin] pr-3 font-poppins mt-2  ">
                      <span className="font-poppins font-bold text-[5vmin] md:text-[3vmin] ">
                        Description:
                      </span>
                      <span className="text-[2.25vmin]">
                        &nbsp;{props.data.description}
                      </span>
                    </p>
                  </div>
                ...
                {screen.width >= 1700 && screen.width <= 1900 && (
                  <div className="descriptionHolder pl-1 mt-2">
                    <p className="text-[2.15vmin] pr-3 font-poppins">
                      <span className="font-poppins font-bold text-[5vmin] md:text-[3vmin] ">
                        Description:
                      </span>
                      <span className="text-[2.35vmin]">
                        &nbsp;{props.data.description}
                      </span>
                    </p>
                  </div>
                ...
                {screen.width >= 1900 && screen.width <= 2047 && (
                  <div className="descriptionHolder pl-1 mt-2">
                    <p className="text-[2.15vmin] pr-1 font-poppins">
                      <span className="font-poppins font-bold text-[5vmin] md:text-[3vmin] ">
                        Description:
                      </span>
                      <span className="text-[2.35vmin]">
                ...
                {screen.width >= 2048 && (
                  <div className="descriptionHolder pl-1 mt-2">
                    <p className="text-[2.45vmin] pr-1 font-poppins">
                      <span className="font-poppins font-bold text-[5vmin] md:text-[3vmin]">
                        Description:
                      </span>
                      <span className="text-[2.35vmin]">
              ...
              <div className="imageHolderh-[50vmin] w-[90vw] md:h-[40vmin] md:w-[80vw] md:ml-[5vmin] lg:h-[30vmin] lg:w-[45vmin]  mt-3">
                <img
                  src={props.data.image}
                  className="max-w-full max-h-full object-contain"
                ></img>
