      ...
      <div>
        {(props.type === "Service" &&
          (screen.width <= 1700 || screen.width >= 1730) && (
            <div className="bg-white card flex flex-col items-center justify-center pl-3 pr-4 md:pr-0 md:p-3 md:pl-2 w-[62vw] h-[70vmin]  md:w-[45vmin] 2xl:w-[52vmin]  border-[#d0cfcf] border-[1px] md:h-[40vmin] gap-y-5  pr-1">
            ...
            (screen.width > 1700 || screen.width < 1730) && (
              <div className="bg-white card flex flex-col items-center justify-center pl-3 pr-4 md:pr-0 md:p-3 md:pl-2 w-[62vw] h-[70vmin]  md:w-[44vmin] 2xl:w-[45vmin]  border-[#d0cfcf] border-[1px] md:h-[40vmin] gap-y-5  pr-1">
                ...
                <div className="flex flex-col justify-center items-center">
                  ...
                  <div className="captionBody w-[100%] lg:w-[80%] text-center  text-textGrey text-[3vmin] md:text-[2.15vmin]">
                    <p className="mt-2 text-[3.45vmin] md:text-[2.15vmin] text-center">
                      {props.data.descr}
                    </p>
                  </div>
                </div>
