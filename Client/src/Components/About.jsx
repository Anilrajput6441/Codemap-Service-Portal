...
const About = () => {
  return (
    <>
      <div className="aboutSection ml-6 mt-20 pb-24 pt-24  pt-4 h">
        {screen.width < 900 && (
          <>
            <div className="aboutHeader">
              <p className="font-extrabold mt-[-2vmin] text-[10vmin] md:text-[10vmin] mt-2">
                About-
        ...
        {screen.width > 900 && screen.width <= 1280 && screen.height >= 800 && (
          <>
            ...
            <div className="contentHolder flex flex-wrap gap-x-9 mt-6 ml-2">
              ...
              <div className="textHolder w-[80vmin]">
        ...
        {screen.width > 1440 && screen.width <= 1700 && (
          <>
            <div className="aboutHeader">
              <p className="font-extrabold text-[8vmin]">
                About-
