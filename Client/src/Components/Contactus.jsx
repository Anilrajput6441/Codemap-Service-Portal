            ...
            <div className="contactFormHolder w-[95vw] md:w-[60vw] mt-1  ml-[-1vmin] ">
              <div className="contactForm  w-[94vw] md:w-[57vw]   border-headerUnderline border-2 rounded-md">
                <form className="flex flex-col gap-y-5 p-5">
                  <p className="text-deepViolet mt-7 ml-3 text-[4.25vmin] font-poppins">
                    Write to us...
                  </p>
                  <input
                    type="text"
                  ...
                  <div className="btnHolder flex justify-center items-center mt-3">
                    <button
                      type="submit"
                      className="submit bg-deepViolet text-white p-2 w-24"
                    >
                      submit
                    </button>
                  </div>
            ...
            <div className="contactFormHolder w-[53vw] mt-10 flex justify-center items-center p-5 mt-[-0.35vmin]">
              <div className="contactForm w-[48vw]  pb-4  border-headerUnderline border-2 rounded-md pl-3 pr-3">
                <form className="flex flex-col gap-y-7 p-5">
                  ...
                  <input
                    type="text"
                    className="text bg-lightGrey p-3 2xl:text-[2.12vmin]"
                    placeholder="Enter your name..."
                  />
                  <input
                    type="text"
                  ...
                  <div className="btnHolder flex justify-center items-center mt-3">
                    <button
                      type="submit"
                      className="submit bg-deepViolet text-white p-2  text-[2.5vmin] p-3"
                    >
                      submit
                    </button>
                  </div>
