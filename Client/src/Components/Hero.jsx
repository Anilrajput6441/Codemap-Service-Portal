            ...
            <div className="font-poppins flex  HeroArea w-[100vw] h-[calc(100vh-27vmin)] md:h-[calc(100vh-10vmin)] pb-8  bg-backgroundMain pb-10">
             <div className="flex">
              ...
              <div className="w-[85vmin] border-mainText  rounded-[4px] lg:ml-16 flex">
                ...
                <p className="ml-[-1vmin] text-mainText font-medium mt-1">( where ideas transform into innovation )</p>
                </div>
               </div>
               </div>
            ...
            <div className="font-poppins flex  HeroArea w-[100vw] h-[calc(100vh-27vmin)] md:h-[calc(100vh-12vmin)] pb-8  bg-backgroundMain pb-10">
             <div className="flex">
              ...
              <div className="w-[85vmin] border-mainText  rounded-[4px] ml-36 flex">
                ...
                <div className="ml-1"> 
                <p className="HeroheaderText font-bold text-[6.85vmin] ml-3">Codemap <span className="text-mainText">Services</span></p>
                <p className="ml-1 text-mainText font-medium mt-2 text-[2.25vmin]">( where ideas transform into innovation )</p>
                </div>
               </div>
               </div>
