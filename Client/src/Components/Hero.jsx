...
const Hero = () => {
  ...
  return (
    ...
    <div className="font-poppins HeroArea w-[100vw] h-[calc(100vh-27vmin)] md:h-[calc(100vh-10vmin)] pb-8  bg-backgroundMain pb-10">
      ...
      || (
        <div className="mainHeroLaptop">
           {screen.width<1700 &&
            <div className="font-poppins flex  HeroArea w-[100vw] h-[calc(100vh-27vmin)] md:h-[calc(100vh-10vmin)] pb-8  bg-backgroundMain pb-10">
             <div className="flex">
              ...
              <div className="w-[85vmin] border-mainText  rounded-[4px] lg:ml-16 flex">
                <div className="verticalLine h-[8vmin]  w-2 bg-mainText mt-4 rounded-[3px]"></div>
                <div className="ml-1"> 
                <p className="HeroheaderText font-bold text-[8vmin] ml-2">Codemap <span className="text-mainText">Services</span></p>
                <p className="ml-1 text-mainText font-medium mt-1">( where ideas transform into innovation )</p>
                </div>
               </div>
               </div>
               <div className="w-[90vmin] text-[2.35vmin] pl-5 pr-5 font-roboto">  
                <p className="ml-8 mt-1">We at codemap aim to deliver quality technical solutions to our clients at the most affordable cost. Give us a chance to make your digital dream come true!!!</p>
                <button className="bg-mainText text-white pr-4 pl-4 mt-9 ml-8 p-2">Contact Us</button>
               </div>
         
              </div>
              <div className="w-[50vw] flex flex-col gap-y-10 lg:ml-[18vmin]  ml-[12vmin] mt-[7vmin]">
               <div className="formHolder w-[30vw] bg-white p-5">
                <p className="text-[4vmin] font-bold">Contact us</p>
                <p className="text-mainText mt-[0.75px]"> ( Get Flat 20% discount on your first order )</p>
                <form className="flex flex-col gap-y-8 p-3 mt-5">
                  <input type="text"  className="text border-gray border-b-[1px] p-2" placeholder="Enter your name..."/>
                  <input type="text"  className="text border-gray border-b-[1px] p-2" placeholder="Enter your email..." />
                  <input type="text"  className="text border-gray border-b-[1px] p-2" placeholder="Enter your phone..." />
                  <select className="text border-gray border-b-[1px] p-2">
                    <option value="None">Which service are you looking for?</option>
                ...
                <div className="flex justify-center items-center">
                  <button className="p-2 bg-mainText text-white w-[20vmin]">Submit</button>
                </div>
                </form>
               </div>
              </div>
            ...
            <div className="font-poppins flex  HeroArea w-[100vw] h-[calc(100vh-27vmin)] md:h-[calc(100vh-15vmin)] pb-8  bg-backgroundMain pb-10">
             <div className="flex">
              ...
              <div className="w-[85vmin] border-mainText  rounded-[4px] ml-36 flex">
                ...
                <div className="ml-1"> 
                <p className="HeroheaderText font-bold text-[6.85vmin] ml-2">Codemap <span className="text-mainText">Services</span></p>
                <p className="ml-1 text-mainText font-medium mt-2 text-[2.25vmin]">( where ideas transform into innovation )</p>
                </div>
               </div>
               </div>
