    ...
    <div className="Holder w-[100vw] bg-backgroundMain p-3">
      ...
      <div className="iconHolder w-[90vw] p-10  flex flex-col justify-center items-center gap-x-20 ml-12 mt-[-3vmin] lg:mt-[-5vmin]">
        <div className="w-[60vw]    flex flex-wrap gap-x-14 justify-center items-center gap-y-4">
          {data.length > 0 && (
            <>
              <div className="mt-10 imageContainer flex flex-wrap justify-center items-center p-10  gap-x-20 gap-y-24">
                {data.map((val) => (
                  <div className="imageHolder h-[20vmin]  w-[20vmin] md:h-[10.15vmin] md:w-[10.15vmin] ">
                    {((val.name === "PHP" || val.name === "Neo4j") && (
                      <>
                        <div className="mt-[1.75vmin] h-[20vmin]  w-[20vmin] md:h-[10.15vmin] md:w-[10.15vmin]">
                          <img
